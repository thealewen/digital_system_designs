...
module lab7_soc_mm_interconnect_0 (
	...
	wire  [104:0] push_buttons_s1_agent_rf_source_data;                                               // push_buttons_s1_agent:rf_source_data -> push_buttons_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] push_buttons_s1_agent_rsp_fifo_out_data;                                            // push_buttons_s1_agent_rsp_fifo:out_data -> push_buttons_s1_agent:rf_sink_data
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> push_buttons_s1_agent:cp_valid
	wire  [103:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> push_buttons_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // push_buttons_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> push_buttons_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> push_buttons_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> push_buttons_s1_agent:cp_endofpacket
	...
	wire          push_buttons_s1_agent_rp_valid;                                                     // push_buttons_s1_agent:rp_valid -> router_009:sink_valid
	wire  [103:0] push_buttons_s1_agent_rp_data;                                                      // push_buttons_s1_agent:rp_data -> router_009:sink_data
	wire          push_buttons_s1_agent_rp_ready;                                                     // router_009:sink_ready -> push_buttons_s1_agent:rp_ready
	wire          push_buttons_s1_agent_rp_startofpacket;                                             // push_buttons_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          push_buttons_s1_agent_rp_endofpacket;                                               // push_buttons_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          push_buttons_s1_agent_rdata_fifo_src_valid;                                         // push_buttons_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] push_buttons_s1_agent_rdata_fifo_src_data;                                          // push_buttons_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          push_buttons_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_007:in_0_ready -> push_buttons_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> push_buttons_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> push_buttons_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // push_buttons_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> push_buttons_s1_agent:rdata_fifo_sink_error
