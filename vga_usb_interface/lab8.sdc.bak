...
create_generated_clock -name sdram_clk [get_ports {DRAM_CLK}] -source [get_nets {m_lab7_soc|sdram_pll|sd1|wire_pll7_clk[1]}] 
...
#shift-window
set_multicycle_path -from [get_clocks {sdram_clk}] -to [get_clocks { m_lab7_soc|sdram_pll|sd1|pll7|clk[0] }] -setup 2
